package GUI;//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables//GEN-LINE:variables
...
public class EditFrame extends javax.swing.JFrame {
	...
	private void applyButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_applyButtonMouseClicked
		...
		if (title.length() > 255 || director.length() > 255 || writers.length() > 255 /* || plot.length() > 255 */
